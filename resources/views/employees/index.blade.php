            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav mx-auto py-0">
                        ...
                        <a href="{{url('employees')}}" class="nav-item nav-link active">Employees</a>
                        @else
                    ...
                    <div class="nav-item ">
                        <a href="{{route('login')}}" class="nav-link  btn  rounded-pill py-2 px-4 flex-shrink-0" style="background-color: rgb(59, 130, 246)" >Login</a>
                    </div>
                    @if (Route::has('register'))
                    <div class="nav-item ">
                        <a href="{{route('register')}}" class="nav-link   rounded-pill py-2 px-4 flex-shrink-0" style="background-color: rgb(59, 130, 246)">Register</a>
                    </div>
                    @endif
                @endauth
                </div>
            ...
            <div class="bg-white overflow-hidden ">
                    <div class="table-responsive" >
                        <table class="table " style="border: 1px solid gray">
                            <thead>
                                <tr>
                                    <th scope="col" style="color: rgb(59, 130, 246)">Name</th>
                            ...
                            <tbody>
                                @foreach ($employees as $employee)
                                    <tr class="">
                                        ...
                                        <td>
                                            <a href={{ route('employees.edit', $employee) }} class="underline"><button class="btn text-white" style="background-color: rgb(60, 190, 248)">Edit</button></a> 
